...
import watercolorBg from './assets/images/sunset_orange_watercolor_bg_1780887065443.png';
  ...
  return (
    <div className="min-h-screen bg-[#FAF6F0] font-sans text-neutral-800 selection:bg-orange-600/15 selection:text-orange-950 relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 opacity-25 mix-blend-multiply">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <filter id="watercolor-wash">
            ...
            <feGaussianBlur in="SourceGraphic" stdDeviation="110" result="blurred" />
            <feTurbulence type="fractalNoise" baseFrequency="0.005" numOctaves="4" result="noise" />
            <feDisplacementMap in="blurred" in2="noise" scale="140" xChannelSelector="R" yChannelSelector="G" />
          </filter>
          <g filter="url(#watercolor-wash)">
            {/* Blended warm & cool watercolor pools mirroring the color palette from your artwork */}
            <circle cx="15%" cy="15%" r="450" fill="#EA580C" opacity="0.22" /> {/* Warm sunset orange */}
            <circle cx="85%" cy="25%" r="520" fill="#3B82F6" opacity="0.18" /> {/* Indigo blue */}
            <circle cx="50%" cy="50%" r="400" fill="#9333EA" opacity="0.15" /> {/* Royal violet pool */}
            <circle cx="15%" cy="75%" r="420" fill="#F59E0B" opacity="0.16" /> {/* Sunset golden amber */}
            <circle cx="80%" cy="80%" r="480" fill="#EC4899" opacity="0.20" /> {/* Bright magenta pink */}
          </g>
        </svg>
      </div>
      ...
      <div className="relative z-10 print:p-0">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-4 text-center lg:text-left space-y-4">
                ...
                <h3 id="about-section-heading" className="text-3xl font-display font-extrabold text-neutral-800 tracking-tight leading-tight">
                  Design Aesthetics &amp; Systems Logic
                </h3>
                <p className="text-sm text-neutral-600 font-sans font-light leading-relaxed">
                  I believe software engineering functions at its absolute peak when developer interfaces, robust APIs, and design guidelines co-exist seamlessly.
                </p>
              </div>

              {/* Graphic center layout cards */}
              <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div id="about-card-1" className="p-6 bg-white/70 backdrop-blur-md border border-[#E6E1D3] rounded-2xl hover:border-neutral-400 transition-all">
                  ...
                  <p className="text-xs text-neutral-600 font-sans leading-relaxed">
                    Developing durable server architectures utilizing Express/Node ecosystems proxying secure API vectors, deploying containerized routines securely under GCP Cloud Run frameworks.
                  </p>
                </div>

                <div id="about-card-2" className="p-6 bg-white/70 backdrop-blur-md border border-[#E6E1D3] rounded-2xl hover:border-neutral-400 transition-all">
                  <div className="w-10 h-10 bg-orange-50 border border-orange-100 rounded-xl flex items-center justify-center text-orange-600 mb-4 font-mono font-bold text-xs">
                    02
                  </div>
                  <h4 className="text-base font-display font-bold text-neutral-800 mb-2 tracking-tight">
                  ...
                  <p className="text-xs text-neutral-600 font-sans leading-relaxed">
                    Crafting highly tactile web interfaces. Utilizing fluid Tailwind utilities, CSS grid structures, standard ResizeObservers and mobile-compliant touching targets.
                  </p>
                </div>
              </div>
            </div>
        ...
        <footer id="master-app-footer" className="bg-[#FAF6F0]/50 border-t border-[#E6E1D3] py-12 text-sm text-neutral-500 relative overflow-hidden print:hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="font-mono text-[10px] uppercase text-neutral-500">
                &copy; 2026 {personalInfo.name} &bull; Built in Modern React &amp; Tailwind CSS
              </div>
