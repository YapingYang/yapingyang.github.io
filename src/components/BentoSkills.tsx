...
import { Award, Terminal, Code, Cpu, Sparkles, Sliders, ChevronRight, Check } from 'lucide-react';
...
export default function BentoSkills() {
  ...
  const handleTerminalSubmit = (e: FormEvent) => {
    ...
    switch (cmd) {
      ...
      case 'clear':
        ...
        return;
      case 'help':
        response = 'Available commands: about, skills, contact, achievements, clear';
        break;
      default:
  ...
  return (
    <section id="skills" className="py-24 bg-transparent text-neutral-800 relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center md:text-left md:flex md:items-end md:justify-between mb-16 border-b border-[#E6E1D3] pb-8">
          <div>
            ...
            <h3 id="skills-section-header" className="text-3xl sm:text-4xl font-display font-extrabold text-[#2D2A26] tracking-tight">
          ...
          >
            <div className="flex items-center justify-between border-b border-[#E6E1D3] pb-3 mb-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-mono text-xs text-neutral-500">interactive-terminal.sh</span>
              </div>
            ...
            >
              {terminalHistory.map((line, idx) => (
                <div key={idx} className="whitespace-pre-wrap leading-relaxed">
                  {line.startsWith('$') ? (
                    <span className="text-orange-600 font-semibold">{line}</span>
                  ) : (
            ...
            {/* Terminal Input Form */}
            <form onSubmit={handleTerminalSubmit} className="mt-3 flex items-center bg-[#FAF6F0] rounded-lg border border-[#E6E1D3] px-3 py-1">
              <span className="font-mono text-xs text-orange-600 mr-2 selection:bg-orange-600/15">$</span>
              <input
          ...
          >
            <div>
              <div className="flex items-center space-x-3 text-orange-600 mb-4">
                ...
                <span className="font-mono text-xs uppercase tracking-wider font-semibold">Proficiency Engine</span>
              </div>
              ...
              <div className="flex space-x-1 bg-[#F4F1EA] p-1 rounded-lg border border-[#E6E1D3] mb-6 sm:max-w-md">
                {skillsData.map((category, idx) => (
                  ...
                  >
                    {idx === 0 ? 'Applied AI' : idx === 1 ? 'Backend / Dev' : 'Products'}
                  </button>
                ))}
              </div>
          ...
          >
            <div>
              <div className="flex items-center space-x-3 text-orange-600 mb-4">
                ...
                <span className="font-mono text-xs uppercase tracking-wider font-semibold">Work Values</span>
              </div>
              ...
              <div className="space-y-5">
                <div className="space-y-1">
                  ...
                  <div className="text-center font-mono text-[9px] text-[#4F4A42] pt-1">Perfect Equidistant Ratio (50/50)</div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-center font-mono text-[9px] text-[#4F4A42] pt-1">Serverless Optimized (30/70)</div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-center font-mono text-[9px] text-[#4F4A42] pt-1">Strict Production Safety (70/30)</div>
                </div>
              </div>
            </div>

            <div className="pt-4 border-t border-[#E6E1D3] mt-6 text-[10px] text-neutral-500 font-sans leading-relaxed">
              Equipped to adapt. Custom build parameters adjusted per project constraints.
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {certificationsData.slice(0, 3).map((cert) => (
                  <div key={cert.id} className="group/cert border-b border-[#E6E1D3] pb-2.5 last:border-0 last:pb-0">
